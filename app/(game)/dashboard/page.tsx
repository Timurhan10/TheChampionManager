          ...
          <div className="bg-panel border border-border-cm rounded-card p-5 shadow-card">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="font-display font-extrabold text-3xl text-emerald">{formatNumber(gameUser?.credits ?? 0)}</div>
              </div>
              <div>
                <div className="text-xs text-text-muted mb-1">CM Puanı (CMP)</div>
                <div className="font-display font-extrabold text-3xl text-amber">{formatNumber(gameUser?.cmp_points ?? 0)}</div>
              </div>
            </div>
          </div>
